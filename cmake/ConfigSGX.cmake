...
if (SGX_ARCH STREQUAL x86)
    ...
    set(SGX_LIBCXX_PATH		    ${SGX_SDK}/include/libcxx)
...
if (SGX_BUILD STREQUAL "DEBUG")
    ...
    set(CMAKE_C_FLAGS 		    "${CMAKE_C_FLAGS} -DDEBUG -UNDEBUG -UEDEBUG") ##maybe remove this line
elseif(SGX_BUILD STREQUAL "PRERELEASE")
    set(SGX_COMMON_CFLAGS 	    "${SGX_COMMON_CFLAGS} -O2")
    set(CMAKE_C_FLAGS 		    "${CMAKE_C_FLAGS} -UDEBUG -DNDEBUG -DEDEBUG") ##maybe remove this line
elseif(SGX_BUILD STREQUAL "RELEASE")
    if(SGX_MODE STREQUAL "HW")
        set(SGX_COMMON_CFLAGS  	"${SGX_COMMON_CFLAGS} -O2")
        set(CMAKE_C_FLAGS 	    "${CMAKE_C_FLAGS} -UDEBUG -DNDEBUG -UEDEBUG") ##maybe remove this line
    else()
...
message(STATUS "SGX_INCLUDE_PATH: ${SGXSDK_INCLUDE_DIRS}")
